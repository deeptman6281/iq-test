  ...
  if (screen === "intro") return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        <div style={S.certPreview}>🎓 <strong style={{ color: "#fbbf24" }}>Official PDF Certificate</strong> — Download your verified IQ certificate for {CERT_PRICE}</div>
      ...
      <div style={S.page}>
        <div style={S.resultCard}>
          ...
          <div style={S.certSection}>
            ...
            {!paid ? (
              <>
                <input style={S.nameInput} placeholder="Enter your full name for the certificate"
          ...
          {showPaywall && (
            <div style={S.modal}>
              <div style={S.modalCard}>
                ...
                <p style={{ color: "#94a3b8", fontSize: 12, textAlign: "center", margin: "0 0 16px" }}>One-time · Instant PDF · No subscription</p>
